...
$ChatModel = Get-EnvValue 'ACTIVE_CHAT_MODEL' 'richardyoung/llama-3.1-8b-instruct-abliterated:latest'
...
if ($missing.Count -gt 0) {
    ...
    Write-Host '  The chat model is ~5 GB and the embedder ~0.6 GB. This is a one-time download.'
